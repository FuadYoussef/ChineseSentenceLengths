...
# this is the code using the waveform analysis library I found. It is poorly documented and not very functional so
# unless we fix it, we are better off using the mfdfa library
